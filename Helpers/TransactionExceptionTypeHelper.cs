...
{
    public class TransactionExceptionTypeHelper
    {
        private static Logger logger = LogManager.Setup().LoadConfigurationFromAppSettings().GetCurrentClassLogger();
        public static async Task<Result<List<wbm_common.DataObjects.TransactionExceptionType.dbRow>>> ExecuteSearch(wbm_common.DataObjects.TransactionExceptionType.Search _TransactionExceptionTypeSearchData, WBMDatabase _WBMDB, IHubCallerClients Clients = null, Func<IHubCallerClients, WBMDatabase, string, int, int, wbm_common.DataObjects.LongRunProcessHeader.dbRow, Task<string>> inCallBackStatusFunction = null, wbm_common.DataObjects.LongRunProcessHeader.dbRow longRunProcessHeader = null)
        {
            Result<List<wbm_common.DataObjects.TransactionExceptionType.dbRow>> rc;
            List<wbm_common.DataObjects.TransactionExceptionType.dbRow> TransactionExceptionTypes;
            switch (_TransactionExceptionTypeSearchData.SearchMode)
            {
                case wbm_common.DataObjects.TransactionExceptionType.Search.SearchModeType.Undefined:
                    {
                        _TransactionExceptionTypeSearchData.GenerateSqlQuery();
                        rc = await _WBMDB.TransactionExceptionType_ListBySql(_TransactionExceptionTypeSearchData.SqlQuery, _TransactionExceptionTypeSearchData.ListSqlParameter);
                        break;
                    }
                case wbm_common.DataObjects.TransactionExceptionType.Search.SearchModeType.SingleID:
                    {
                        rc = await _WBMDB.TransactionExceptionTypeList_SearchByID(_TransactionExceptionTypeSearchData.ID);
                        break;
                    }
                case wbm_common.DataObjects.TransactionExceptionType.Search.SearchModeType.AllRecords:
                    {
                        rc = await _WBMDB.TransactionExceptionType_List();
                        break;
                    }
                default:
                    {
                        logger.Error("TransactionExceptionTypeHelper.ExecuteSearch: TransactionExceptionType Search Mode Type Error");
                        rc = Result.Exception<List<wbm_common.DataObjects.TransactionExceptionType.dbRow>>("Internal Exception occured");
                        break;
                    }
            }
        ...
        public class TransactionExceptionTypeSave
        {
            private wbm_common.DataObjects.TransactionExceptionType saveObject { get; set; }
            private wbm_common.DataObjects.TransactionExceptionType.dbRow saveRow { get; set; }

            private wbm_common.DataObjects.TransactionExceptionType.dbRow existRow { get; set; }
            ...
            public TransactionExceptionTypeSave(wbm_common.DataObjects.TransactionExceptionType saveObject, int UserID, WBMDatabase wBMDB)
            {
            ...
            public Boolean CheckExist()
            {
                ...
                if (saveRow.ID > 0)
                {
                    Result<wbm_common.DataObjects.TransactionExceptionType.dbRow> rc = _WBMDB.TransactionExceptionType_ReadByID(saveRow.ID).GetAwaiter().GetResult();
                ...
                {
                    Result<wbm_common.DataObjects.TransactionExceptionType.dbRow> rcexist = _WBMDB.TransactionExceptionType_SearchByID(saveRow.ID).GetAwaiter().GetResult();
                    ...
                    else
                    {
                        ...
                        logger.Error("TransactionExceptionTypeSave ID " + saveRow.ID.ToString() + " already exists");
                        ReturnState = 400;
                        SavedSuccessfully = false;
                        return false;
                    }
            ...
            public Boolean CheckForChanges()
            {
                ...
                return ct.CheckForChanges(existRow, saveRow, wbm_common.DataObjects.TransactionExceptionType.ListChangeTrackerData);
            }
            ...
            public void SetChanged()
            {
                ...
                else
                {
                    ...
                    changeHeaderRow = WBM_API.Helpers.ChangeTracking.Create_ChangeHeader_dbRow((int)wbm_common.DataObjects.ChangeTracking.ChangeHeaderTableID.TransactionExceptionType,
            ...
            {
                Result<int> sr = _WBMDB.TransactionExceptionType_Insert(saveRow).GetAwaiter().GetResult();
            ...
            public Boolean Save_Update_or_Delete()
            {
                ...
                Result<int> cuResult = _WBMDB.TransactionExceptionType_Update(saveRow).GetAwaiter().GetResult();
                ...
                if (cuResult.IsSuccess)
                {
                    ...
                    if (chResult.IsSuccess)
                    {
                        ...
                        int ChangeHeaderTableID = (int)wbm_common.DataObjects.ChangeTracking.ChangeHeaderTableID.TransactionExceptionType;
