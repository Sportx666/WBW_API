...
{
    public class ProcessingRuleTriggerConditionHelper
    {
        private static Logger logger = LogManager.Setup().LoadConfigurationFromAppSettings().GetCurrentClassLogger();
        public static async Task<Result<List<wbm_common.DataObjects.ProcessingRuleTriggerCondition.dbRow>>> ExecuteSearch(wbm_common.DataObjects.ProcessingRuleTriggerCondition.Search _ProcessingRuleTriggerConditionSearchData, WBMDatabase _WBMDB, IHubCallerClients Clients = null, Func<IHubCallerClients, WBMDatabase, string, int, int, wbm_common.DataObjects.LongRunProcessHeader.dbRow, Task<string>> inCallBackStatusFunction = null, wbm_common.DataObjects.LongRunProcessHeader.dbRow longRunProcessHeader = null)
        {
            Result<List<wbm_common.DataObjects.ProcessingRuleTriggerCondition.dbRow>> rc;
            List<wbm_common.DataObjects.ProcessingRuleTriggerCondition.dbRow> ProcessingRuleTriggerConditions;
            switch (_ProcessingRuleTriggerConditionSearchData.SearchMode)
            {
                case wbm_common.DataObjects.ProcessingRuleTriggerCondition.Search.SearchModeType.Undefined:
                    {
                        _ProcessingRuleTriggerConditionSearchData.GenerateSqlQuery();
                        rc = await _WBMDB.ProcessingRuleTriggerCondition_ListBySql(_ProcessingRuleTriggerConditionSearchData.SqlQuery, _ProcessingRuleTriggerConditionSearchData.ListSqlParameter);
                        break;
                    }
                case wbm_common.DataObjects.ProcessingRuleTriggerCondition.Search.SearchModeType.SingleID:
                    {
                        rc = await _WBMDB.ProcessingRuleTriggerConditionList_SearchByID(_ProcessingRuleTriggerConditionSearchData.ID);
                        break;
                    }
                case wbm_common.DataObjects.ProcessingRuleTriggerCondition.Search.SearchModeType.AllRecords:
                    {
                        rc = await _WBMDB.ProcessingRuleTriggerCondition_List();
                        break;
                    }
                default:
                    {
                        logger.Error("ProcessingRuleTriggerConditionHelper.ExecuteSearch: ProcessingRuleTriggerCondition Search Mode Type Error");
                        rc = Result.Exception<List<wbm_common.DataObjects.ProcessingRuleTriggerCondition.dbRow>>("Internal Exception occured");
                        break;
                    }
            }
        ...
        public class ProcessingRuleTriggerConditionSave
        {
            private wbm_common.DataObjects.ProcessingRuleTriggerCondition saveObject { get; set; }
            private wbm_common.DataObjects.ProcessingRuleTriggerCondition.dbRow saveRow { get; set; }

            private wbm_common.DataObjects.ProcessingRuleTriggerCondition.dbRow existRow { get; set; }
            ...
            public ProcessingRuleTriggerConditionSave(wbm_common.DataObjects.ProcessingRuleTriggerCondition saveObject, int UserID, WBMDatabase wBMDB)
            {
            ...
            public Boolean CheckExist()
            {
                ...
                if (saveRow.ID > 0)
                {
                    Result<wbm_common.DataObjects.ProcessingRuleTriggerCondition.dbRow> rc = _WBMDB.ProcessingRuleTriggerCondition_ReadByID(saveRow.ID).GetAwaiter().GetResult();
                ...
                {
                    Result<wbm_common.DataObjects.ProcessingRuleTriggerCondition.dbRow> rcexist = _WBMDB.ProcessingRuleTriggerCondition_SearchByID(saveRow.ID).GetAwaiter().GetResult();
                    ...
                    else
                    {
                        ...
                        logger.Error("ProcessingRuleTriggerConditionSave ID " + saveRow.ID.ToString() + " already exists");
                        ReturnState = 400;
                        SavedSuccessfully = false;
                        return false;
                    }
            ...
            public Boolean CheckForChanges()
            {
                ...
                return ct.CheckForChanges(existRow, saveRow, wbm_common.DataObjects.ProcessingRuleTriggerCondition.ListChangeTrackerData);
            }
            ...
            public void SetChanged()
            {
                ...
                else
                {
                    ...
                    changeHeaderRow = WBM_API.Helpers.ChangeTracking.Create_ChangeHeader_dbRow((int)wbm_common.DataObjects.ChangeTracking.ChangeHeaderTableID.ProcessingRuleTriggerCondition,
            ...
            {
                Result<int> sr = _WBMDB.ProcessingRuleTriggerCondition_Insert(saveRow).GetAwaiter().GetResult();
            ...
            public Boolean Save_Update_or_Delete()
            {
                ...
                Result<int> cuResult = _WBMDB.ProcessingRuleTriggerCondition_Update(saveRow).GetAwaiter().GetResult();
                ...
                if (cuResult.IsSuccess)
                {
                    ...
                    if (chResult.IsSuccess)
                    {
                        ...
                        int ChangeHeaderTableID = (int)wbm_common.DataObjects.ChangeTracking.ChangeHeaderTableID.ProcessingRuleTriggerCondition;
